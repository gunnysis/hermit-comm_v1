...
| 파일 | 내용 |
|------|------|
| `20260301000001_schema.sql` | 확장, 함수, 테이블, 인덱스, 뷰, 트리거 |
| `20260301000002_rls.sql`    | RLS 활성화 + 전체 정책 |
| `20260301000003_infra.sql`  | 권한(grants) + Storage 버킷·정책 |

> 이전 이력(001~023, 20260223110128, 20260301000000)은 모두 이 3개 파일로 통합됨.
...
```
Local, Remote 모두에 `20260301000001`, `20260301000002`, `20260301000003`이 있으면 이미 적용됨.
