    ...
    <Container>
      ...
      <View className="flex-1">
        <ScrollView className="flex-1" contentContainerStyle={{ paddingBottom: 16 }}>
          <ScreenHeader
            title="내 그룹"
            subtitle="참여 중인 프로그램/소모임의 익명 게시판"
          />
            ...
            {validGroups.length === 0 ? (
              ...
              validGroups.map((group) => (
                <Pressable
                  ...
                  onPress={() =>
                    router.push(
                      `/groups/${group.id}` as Parameters<typeof router.push>[0],
                    )
                  }
                  className="bg-white rounded-2xl px-4 py-4 border border-cream-200 active:opacity-80">
